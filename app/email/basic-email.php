...
EOT;
     ...
     * @return string
     */
    protected function additionalStyle()
    {
        return '';
    }
        ...
        <table class="footer" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="width: 284px;"></td>
                    <td>
                        <a href="https://dentalqore.com" target="_blank">
                            <img src="http://{$baseUrl}/app/email/media/logo.png" alt="DentalQore">
                        </a>
                    </td>
                <td style="width: 284px;"></td>
            </tr>
...
<tr>
    <td class="sub-container">
        <p>Thank you for choosing DentalQore. We are honored to serve you. Let us know if you have any questions: (866) 664-5216.</p>
        <h3>The DentalQore Team</h3>
    </td>
</tr>
